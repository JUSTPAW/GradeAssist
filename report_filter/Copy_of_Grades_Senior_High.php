...
if ($semester == 1) {
    $html .= '<td style="font-weight: bold; font-size: 10px; vertical-align: middle; line-height: .50cm; width: 24%;" align="center">
                    1st Quarter
                </td>
                <td style="font-weight: bold; font-size: 10px; vertical-align: middle; line-height: .50cm; width: 24%;" align="center">
                    2nd Quarter
                </td>';
} elseif ($semester == 2) {
    $html .= '<td style="font-weight: bold; font-size: 10px; vertical-align: middle; line-height: .50cm; width: 24%;" align="center">
    ...
    $html .= '<td style="font-weight: bold; font-size: 10px; vertical-align: middle; line-height: .50cm; width: 24%;" align="center">Subject Teacher</td>
    </tr>';
...
if (!empty($school_year_id) && !empty($class_id) && !empty($student_id)) {
    ...
    $query_subjects = "SELECT l.*, f.*, s.courseTitle, s.courseCode, sg.q1_grade, sg.q2_grade, sg.q3_grade, sg.q4_grade, s.id as subject_id
                        ...
                        WHERE sg.student_id = $student_id AND l.class_id = $class_id AND l.school_year_id = $school_year_id AND l.semester = $semester";
    ...
    if (mysqli_num_rows($query_run) > 0) {
        while ($row = mysqli_fetch_assoc($query_run)) {
            ...
            if (strpos($course_code, 'MAPEH') !== false) {
                ...
                $html .= '<tr>
                    ...
                    if ($semester == 1) {
                        if ($q1_grade > 0) {
                            $html .= '<td style="font-weight: bold; font-size: 10px; vertical-align: middle; line-height: .50cm; width: 24%;" align="center">'.$q1_grade.'</td>';
                        } else {
                            $html .= '<td style="font-weight: bold; font-size: 10px; vertical-align: middle; line-height: .50cm; width: 24%;" align="center"></td>';
                        }
                        if ($q2_grade > 0) {
                            $html .= '<td style="font-weight: bold; font-size: 10px; vertical-align: middle; line-height: .50cm; width: 24%;" align="center">'.$q2_grade.'</td>';
                        } else {
                            $html .= '<td style="font-weight: bold; font-size: 10px; vertical-align: middle; line-height: .50cm; width: 24%;" align="center"></td>';
                        }
                    } elseif ($semester == 2) {
                        if ($q3_grade > 0) {
                            $html .= '<td style="font-weight: bold; font-size: 10px; vertical-align: middle; line-height: .50cm; width: 24%;" align="center">'.$q3_grade.'</td>';
                        } else {
                            $html .= '<td style="font-weight: bold; font-size: 10px; vertical-align: middle; line-height: .50cm; width: 24%;" align="center"></td>';
                        }
                        if ($q4_grade > 0) {
                            $html .= '<td style="font-weight: bold; font-size: 10px; vertical-align: middle; line-height: .50cm; width: 24%;" align="center">'.$q4_grade.'</td>';
                        } else {
                            $html .= '<td style="font-weight: bold; font-size: 10px; vertical-align: middle; line-height: .50cm; width: 24%;" align="center"></td>';
                        }
                    }
        ...
        if ($mapeh_grades['count'] > 0) {
            ...
            if ($semester == 1) {
                if ($average_q1 > 0) {
                    $html .= '<td style="font-weight: bold; font-size: 10px; vertical-align: middle; line-height: .50cm; width: 242424%;" align="center">'.$average_q1.'</td>';
                } else {
                    $html .= '<td style="font-weight: bold; font-size: 10px; vertical-align: middle; line-height: .50cm; width: 242424%;" align="center"></td>';
                }
                if ($average_q2 > 0) {
                    $html .= '<td style="font-weight: bold; font-size: 10px; vertical-align: middle; line-height: .50cm; width: 242424%;" align="center">'.$average_q2.'</td>';
                } else {
                    $html .= '<td style="font-weight: bold; font-size: 10px; vertical-align: middle; line-height: .50cm; width: 242424%;" align="center"></td>';
                }
            } elseif ($semester == 2) {
                if ($average_q3 > 0) {
                    $html .= '<td style="font-weight: bold; font-size: 10px; vertical-align: middle; line-height: .50cm; width: 242424%;" align="center">'.$average_q3.'</td>';
                } else {
                    $html .= '<td style="font-weight: bold; font-size: 10px; vertical-align: middle; line-height: .50cm; width: 242424%;" align="center"></td>';
                }
                if ($average_q4 > 0) {
                    $html .= '<td style="font-weight: bold; font-size: 10px; vertical-align: middle; line-height: .50cm; width: 242424%;" align="center">'.$average_q4.'</td>';
                } else {
                    $html .= '<td style="font-weight: bold; font-size: 10px; vertical-align: middle; line-height: .50cm; width: 242424%;" align="center"></td>';
                }
            }

            // Append teacher name to MAPEH consolidated row
            $html .= '<td style="font-weight: bold; font-size: 10px; vertical-align: middle; line-height: .50cm; width: 24%;" align="left">'.$teacherName.'
            </td>
            </tr>';
            ...
            foreach ($individual_mapeh_subjects as $subject) {
                ...
                if ($semester == 1) {
                    if ($subject['q1_grade'] > 0) {
                        $html .= '<td style="font-weight: bold; font-size: 10px; vertical-align: middle; line-height: .50cm; width: 2424%;" align="center">'.$subject['q1_grade'].'</td>';
                    } else {
                        $html .= '<td style="font-weight: bold; font-size: 10px; vertical-align: middle; line-height: .50cm; width: 2424%;" align="center"></td>';
                    }
                    if ($subject['q2_grade'] > 0) {
                        $html .= '<td style="font-weight: bold; font-size: 10px; vertical-align: middle; line-height: .50cm; width: 2424%;" align="center">'.$subject['q2_grade'].'</td>';
                    } else {
                        $html .= '<td style="font-weight: bold; font-size: 10px; vertical-align: middle; line-height: .50cm; width: 2424%;" align="center"></td>';
                    }
                } elseif ($semester == 2) {
                    if ($subject['q3_grade'] > 0) {
                        $html .= '<td style="font-weight: bold; font-size: 10px; vertical-align: middle; line-height: .50cm; width: 2424%;" align="center">'.$subject['q3_grade'].'</td>';
                    } else {
                        $html .= '<td style="font-weight: bold; font-size: 10px; vertical-align: middle; line-height: .50cm; width: 2424%;" align="center"></td>';
                    }
                    if ($subject['q4_grade'] > 0) {
                        $html .= '<td style="font-weight: bold; font-size: 10px; vertical-align: middle; line-height: .50cm; width: 2424%;" align="center">'.$subject['q4_grade'].'</td>';
                    } else {
                        $html .= '<td style="font-weight: bold; font-size: 10px; vertical-align: middle; line-height: .50cm; width: 2424%;" align="center"></td>';
                    }
                }
        ...
        if ($semester == 1) {
                if ($q1_general_average > 0) {
                    $html .= '<td style="font-weight: bold; font-size: 10px; vertical-align: middle; line-height: .50cm; width: 24%;" align="center">'. $q1_general_average .'</td>';
                } else {
                    $html .= '<td style="font-weight: bold; font-size: 10px; vertical-align: middle; line-height: .50cm; width: 24%;" align="center"></td>';
                }

                if ($q2_general_average > 0) {
                    $html .= '<td style="font-weight: bold; font-size: 10px; vertical-align: middle; line-height: .50cm; width: 24%;" align="center">'. $q2_general_average .'</td>';
                } else {
                    $html .= '<td style="font-weight: bold; font-size: 10px; vertical-align: middle; line-height: .50cm; width: 24%;" align="center"></td>';
                }
        } elseif ($semester == 2) {
                if ($q3_general_average > 0) {
                    $html .= '<td style="font-weight: bold; font-size: 10px; vertical-align: middle; line-height: .50cm; width: 24%;" align="center">'. $q3_general_average .'</td>';
                } else {
                    $html .= '<td style="font-weight: bold; font-size: 10px; vertical-align: middle; line-height: .50cm; width: 24%;" align="center"></td>';
                }

                if ($q4_general_average > 0) {
                    $html .= '<td style="font-weight: bold; font-size: 10px; vertical-align: middle; line-height: .50cm; width: 24%;" align="center">'. $q4_general_average .'</td>';
                } else {
                    $html .= '<td style="font-weight: bold; font-size: 10px; vertical-align: middle; line-height: .50cm; width: 24%;" align="center"></td>';
                }
         }
    ...
    $html .= '<tr><td colspan="4" align="center">Please provide valid inputs for School Year, Class, and Student.</td></tr>';
}
