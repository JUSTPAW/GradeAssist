...
$pdf->Cell(0, 1.0, '(High School Department)', 0, 1, 'C');
...
$html = '<table border="1" >
            <thead>
                <tr>
                    ...
                    <th style="text-align: center; font-weight: bold; width: 4.78cm; font-family: times, sans-serif; font-size: 10px;">Name of Faculty
                    </th>

                    <th style="text-align: center; font-weight: bold; width: 3.65cm; font-family: times, sans-serif; font-size: 10px;">Rank
                    </th>

                    <th style="text-align: center; font-weight: bold; width: 2.30cm; font-family: times, sans-serif; font-size: 10px;">Gender
                    </th>
