...
<script>
    function disableSubmitButton() {
        ...
        document.getElementById('signInButton').setAttribute('disabled', 'disabled');
         document.getElementById('signInButton').style.backgroundColor = '#FFC700'; 
        document.getElementById('signInButton').style.borderColor = '#FFC700';
        document.getElementById('signInButton').style.borderRadius = '20px';
    }
    ...
    function enableSubmitButton(response) {
        ...
        document.getElementById('signInButton').style.backgroundColor = '#4CAF50'; 
        document.getElementById('signInButton').style.borderColor = '#4CAF50';
        document.getElementById('signInButton').style.borderRadius = '20px';
    }
    ...
    function onloadCallback() {
        ...
        grecaptcha.render('captcha', {
            'sitekey': '6Le2S9EpAAAAANX8ObDHwsKV63izF_dxNE83tFs8',
